...
namespace CoordinateSharpTesterConsole2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            d(c.ToString());
            c = new Coordinate(40.0352, -74.5844, DateTime.Now);
            d(c.ToString());
            ...
            d("MOON NAME: " + c.CelestialInfo.AstrolgicalSigns.MoonName);
            d("MOON SIGN: " + c.CelestialInfo.AstrolgicalSigns.MoonSign);
            d("ZODIAC SIGN: " + c.CelestialInfo.AstrolgicalSigns.ZodiacSign);
            ...
            catch (NullReferenceException ex) { d(ex.Message); }
            c.LoadCelestialInfo();
