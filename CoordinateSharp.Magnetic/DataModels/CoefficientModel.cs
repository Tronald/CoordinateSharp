...
namespace CoordinateSharp.Magnetic
{
    ...
    /// </summary>
    internal class CoefficientModel
    {
        public CoefficientModel(int degree, int order, double? gm, double? hm, double? gtm, double? htm)
        {
            Degree = degree;
            Order = order;
            Gm = gm;
        ...
        internal double? Gm { get; set; }
        internal double? Hm { get; set; }
        internal double? Gtm { get; set; }
        internal double? Htm { get; set; }
    }
}
