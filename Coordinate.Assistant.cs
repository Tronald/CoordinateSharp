...
namespace CoordinateSharp
{
    ...
    {     
        ...
        private void Vincenty(Coordinate c1, Coordinate c2)
        {
            ...
            // elliptic code
            double[] cde = Dist_Ell(lat1, -lon1, lat2, -lon2, ellipse);  // ellipse uses East negative
        ...
        private double[] Dist_Ell(double glat1, double glon1, double glat2, double glon2, double[] ellipse)
        {
