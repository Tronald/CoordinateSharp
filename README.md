...
ANNOUNCEMENT: v2.1.1.1 development has begun. This version is going to focus on simplifying constructors, better management of circular references and better property change notification. It is also going to focus on proper assignment of user mutable vs user immutable properties. Lastly, code examples are going to be provided in the library documentation in order to give developers a more standard documentation experience outside of the Developer Guide. This version should give the user an even simplier experience when using CoordinateSharp. 
